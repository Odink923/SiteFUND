...
const ReviewsCarrousel = () => {
    ...
    return (
        <div className="relative w-full">
            ...
            >
                {slides.map((slide, index) => (
                    <SwiperSlide key={index}>
                        <div className="relative bg-[#20202026] lg:w-[63.23vw] lg:h-[20.16vw] lg:ml-[4.21vw] rounded-[3.13vw] ">
                            {slide.title && (
                                <div className="text-[#202020] pt-[4.58vw]  pl-[4.27vw] lg:w-[45.78vw] lg:h-[10.00vw] leading-none ">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <h2 className="lg:text-[1.88vw] lg:pl-[1.82vw] font-assistant font-semibold">{slide.title}</h2>
                                    </div>

                                    <p className="lg:text-[1.04vw] lg:pt-[1.82vw] text-justify">{slide.description}</p>
                                </div>
                            )}
                        </div>
                    </SwiperSlide>
            ...
            <div className="flex ml-[5.21vw] mt-[3.13vw] space-x-[1.46vw]">
                <button
                    onClick={() => swiperInstance && swiperInstance.slidePrev()}
                    className="
                        bg-white hover:bg-gray-200 text-black rounded-full focus:outline-none transition-colors duration-300 shadow-lg hover:shadow-xl
